  ...
  <div className="relative z-10">
    {/* <h1 className="text-white">Your Content Here</h1> */}
          ...
          <div className="relative z-10 text-white 2xl:mt-[117px] xl:mt-[165px] 2xl:ml-[-825px] xl:ml-[-567px]  ">
            <h1 className="text-4xl font-hp-simplified text-[44px] 2xl:ml-[7px] xl:ml-[-32px]">Get started with your HP printer</h1>
            <p className="mt-[35px] text-[24px] xl:ml-[266px] 2xl:ml-[309px]">Enter your printer name and model number to get the right HP software and drivers.</p>
            ...
            {/* Dropdown for filtered models */}
            {filteredModels.length > 0 && (
              <ul className="absolute left-0 mt-1 w-full max-w-lg bg-white border border-gray-300 rounded-lg shadow-lg z-10 2xl:ml-[313px] xl:ml-[271px] text-black">
                {filteredModels.map((model) => (
                  <li
                    key={model}
