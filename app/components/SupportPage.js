            ...
            <div className="flex flex-col items-center py-14 space-y-14">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-7xl px-8">
                    ...
                    <div className="flex flex-col items-center text-center border border-gray-200 p-8 rounded-lg shadow-md">
                        <Image src="/windows.jpg" alt="Windows 11" width={350} height={180} className="rounded-lg object-cover" />
                    ...
                    {/* Solution 2 */}
                    <div className="flex flex-col items-center text-center border border-gray-200 p-8 rounded-lg shadow-md">
                        <Image src="/scan.png" alt="Printer Setup" width={350} height={180} className="rounded-lg object-cover" />
                    ...
                    {/* Solution 3 */}
                    <div className="flex flex-col items-center text-center border border-gray-200 p-8 rounded-lg shadow-md">
                        <Image src="/offline.png" alt="Printer Queue" width={350} height={180} className="rounded-lg object-cover" />
                ...
                <div className="w-full bg-gray-100 py-14">
                    <div className="flex flex-col md:flex-row items-center max-w-7xl mx-auto px-8 space-y-10 md:space-y-0 md:space-x-12">
                        ...
                        <div className="flex-1 flex justify-center md:justify-end">
                            <Image src="/Deskjet.avif" alt="Printer Example" width={600} height={350} className="rounded-lg object-cover" />
                        </div>
                    </div>
                </div>
            </div>
            <div className="flex justify-center">
                <Image src="/slider.webp" alt="Printer Example" width={1050} height={230} className="mt-[81px] mb-[114px] rounded-lg" />
            </div>
        </>
    );
}
