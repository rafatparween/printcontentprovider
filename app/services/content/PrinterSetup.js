...
export default function PrinterSetup() {
  ...
  return (
    <div className="flex flex-col items-center py-14 space-y-14 mt-[-33px]">
      {/* Top Section */}
      <div className="flex flex-col md:flex-row items-center md:items-start space-y-10 md:space-y-0 md:space-x-12 w-full max-w-7xl p-10 border border-gray-200 rounded-lg shadow-lg">
        {/* Image Section */}
        <div className="w-full md:w-1/2">
          <Image
            src="/Printer.avif" // Replace with the actual path to your image
        ...
        <div className="w-full md:w-1/2 space-y-8">
          <h2 className="text-4xl font-bold">How to Set Up Your Printer</h2> {/* Further increased text size */}
          <p className="text-xl leading-relaxed">
            Click Printer Setup for step-by-step guidance on how to set up, configure, and register your printer.
          </p>
          <button 
            className="bg-[#007DBD] text-white py-3 px-8 rounded text-lg font-medium hover:bg-blue-700 transition duration-200"
          ...
          <div className="text-lg">
            <span className="font-semibold">More support</span><br />
            <a href="#" className="text-[#007DBD] underline hover:text-blue-600">
              Get Instant Support
            </a>
          </div>
        </div>
